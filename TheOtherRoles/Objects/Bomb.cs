...
public class Bomb
{
    ...
    public Bomb(Vector2 p)
    {
        ...
        if (PlayerControl.LocalPlayer == Bomber.bomber) bomb.SetActive(true);
        Bomber.bomb = this;
        var c = Color.white;
        var g = Color.red;
    ...
    public static Sprite getBackgroundSprite()
    {
        ...
        backgroundSprite =
            Helpers.loadSpriteFromResources("BombBackground.png", 110f / Bomber.hearRange);
    ...
    public static void explode(Bomb b)
    {
        ...
        if (Bomber.bomber != null)
        {
            ...
            try
            {
                SoundEffectsManager.playAtPosition("bombExplosion", position, 1.6f, Bomber.hearRange);
            }
            catch (Exception e)
            {
    ...
    public static void update()
    {
        ...
        if (Vector2.Distance(PlayerControl.LocalPlayer.GetTruePosition(), Bomber.bomb.bomb.transform.position) > 1f)
            canDefuse = false;
        else canDefuse = true;
    }

...
namespace TheOtherRoles {
    public class CustomOptionHolder {
        ...
        public static void Load() {
            ...
            modifierLighterln = CustomOption.Create(1053, Types.Modifier, cs(Color.yellow, "Lighterln"), rates, null, true);
            modifierLighterlnQuantity = CustomOption.Create(1054, Types.Modifier, cs(Color.yellow, "Lighterln Quantity"), ratesModifier, modifierLighterln);
            modifierLighterlnVision = CustomOption.Create(1055, Types.Modifier, "Vision With Lighterln", new string[] { "+10%", "+20%", "+30%", "+40%", "+50%" }, modifierLighterln);

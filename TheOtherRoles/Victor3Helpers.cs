...
namespace TheOtherRoles
{
    public class Victor3Helpers
    {
        ...
        public static List<Vector3> buttonPositions = new()
        {
         new Vector3(-2f, -0.06f, 0),// Not usable for imps beacuse of new button positions!
         new Vector3(0, -0.06f, 0),//As Garlic Button
         new Vector3(-3f, -0.06f, 0),
         new Vector3(-4f, -0.06f, 0),
         new Vector3(0f, 1f, 0f),// Not usable for imps beacuse of new button positions!
         new Vector3(-1f, 1f, 0f),// Not usable for imps beacuse of new button positions!
         new Vector3(-2f, 1f, 0f),
         new Vector3(-3f, 1f, 0f),
         new Vector3(0f, 2.06f, 0f),
         new Vector3(-1, -0.06f, 0)
    };
    }
}
